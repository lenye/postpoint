...
`PostPoint`下载 [最新版本](https://github.com/lenye/postpoint/releases/tag/v25.11.1)

#### Windows 操作系统

1. 解压下载文件`postpoint_v25.11.1_windows_x86_64.zip`；
...
4. 运行`postpoint.exe serve`，开始消息推送 API 服务；
   ...
   2025-07-01T22:07:01.627+0800    info    PostPoint Free v25.11.1 windows/amd64, https://github.com/lenye/postpoint
   ```   
