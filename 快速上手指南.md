...
`postpoint`下载 [最新版本](https://github.com/lenye/postpoint/releases/tag/v25.7.4)

样例配置文件 [config.toml](config.toml)

### windows 操作系统

1. 解压下载文件`postpoint_v25.7.4_windows_x86_64.zip`；
...
3. 运行`postpoint.exe test`，测试配置是否正确；
   ...
   2025-07-01T22:07:01.771+0800    info    postpoint    {"type": "free", "version": "25.7.4", "web": "https://github.com/lenye/postpoint", "os/arch": "windows/amd64"}
...
4. 运行`postpoint.exe serve`，开始消息推送 API 服务；
   ...
   2025-07-01T22:07:01.627+0800    info    postpoint    {"type": "free", "version": "25.7.4", "web": "https://github.com/lenye/postpoint", "os/arch": "windows/amd64"}
